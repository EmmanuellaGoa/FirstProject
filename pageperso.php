...
<html lang="fr">
    ...
    <header>
        ...
        <ul class="nav">
            ...
            <li> <a href="#" style="text-decoration: underline;font-size:20px;"> <strong>*<?php echo $perso?></strong>* </a> </li>
            <li> <a href="deconnexion.php" id="conect" style="padding: 10px;">SE DECONNECTER</a> </li>
        </ul>
    </header>
    ...
    <section id="n2"><br><br>
       <div class="tex2">
            <span >NOS CATEGORIES DE VETEMENTS👗, CHAUSSURES👠 & SACS👜</span>
       </div>
    ...
    <section id="n3">
       <a id="n3a" href="Model_Chic.php?prenom=<?php echo $perso ?>" style="text-decoration: none;">VOIR PLUS</a> 
    </section>
    ...
    <footer>
        ...
        <div><h4>Mode de Livraison</h4><img src="image/livr.jpg" style="width: 50px;height: 50px;margin-left: 20px;">
            <img src="image/favicon (2).ico"  style="width: 50px;height: 50px;" > 
